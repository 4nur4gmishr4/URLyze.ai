...
export const ERROR_CATEGORY: Record<ErrorCode, ErrorCategory> = {
	...
	AUTH_GOOGLE_CONFIG: 'AUTH_ERROR',
	AUTH_GOOGLE_FAILED: 'AUTH_ERROR',
	AUTH_GOOGLE_INVALID: 'AUTH_ERROR',
	AUTH_STATE_MISMATCH: 'AUTH_ERROR',
	NOT_FOUND: 'INTERNAL',
	INTERNAL: 'INTERNAL'
};
...
export const errorMap: Record<ErrorCode, number> = {
	...
	DATABASE_ERROR: 500,
	RATE_LIMITED: 429,
	AUTH_GOOGLE_CONFIG: 503,
	AUTH_GOOGLE_FAILED: 502,
